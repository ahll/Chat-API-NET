...
namespace WhatsAppApi.Register
{
    class WaToken
    {
        ...
        {
            string token = "PdA2DJyKoUrwLw1Bg6EIhzh502dF9noR9uFCllGk1478194306452" + number;
        ...
        public static string GenerateTokenAndroid(string number)
        {
            ...
            var classesMd5 = Settings.WhatsConstants.ClassesMd5Register; // "1naz8gL5pIYWbtaOZ3207g=="; // 2.17.16
