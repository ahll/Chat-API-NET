     ...
     public class TokenDictionary
     {
        ...
        "account",
         ...
         public TokenDictionary()
         {
            ...
            for (int i = 0; i < TokenDictionary.secondaryStrings.Length; i++)
            {
                string text = TokenDictionary.secondaryStrings[i];
                if (text != null)
                {
                    this.secondaryStringDict.Add(text, i);
                }
            }
        }

         public bool TryGetToken(string str, ref bool secondary, ref int token)
         {
         ...
         public void GetToken(int token, ref string str, bool secondary = false)
         {
             string[] array = TokenDictionary.primaryStrings;
             if (secondary)
             {
                array = TokenDictionary.secondaryStrings;
             } else if (token > 236 && token < 236 + TokenDictionary.secondaryStrings.Length)
             {
                array = TokenDictionary.secondaryStrings;
                token = token - 237;
             }

             if (token < 0 || token > array.Length - 1 )
             {
                str = null;
                return;
             }
